...
uint256 hashGenesisBlock("0x85c797a96701e8bc759a7e889342b6e11b4755dfdf5442f524bacdbead9c50e1");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // LogCoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 43200; // LogCoin: 3.5 days
static const int64 nTargetSpacing = 60; // LogCoin: 2.5 minutes
...
{
    // LogCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcaff902a8acd84adf9efaa4b3c0c322aa550d996771a21c9931b5c05b7035674");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "johnnychop best twitch stream by far";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("49f951a1a98d8dfbd2d201e76de9cabc4829c177cc407e76882e148348ad3fc362c4e5e9478d43096c12a848429f716ad58981efbd441a0c913c7241f5544b2c04") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1542463319;
        block.nBits    = 504365644;
        block.nNonce   = 779926748;

        if (fTestNet)
        {
            block.nTime    = 1542463319;
            block.nNonce   = 4049112078;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x56bf997a4a5ff52a20ca88d9bf94188bbcfc0fa013e22b689fd3d9f026627200"));
        block.print();
